        ...
        {isFormOpen && (
          <CardContent className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="space-y-2">
                <Label htmlFor="correo">Correo (recibe reportes)</Label>
                <Input
                  id="correo"
                  type="email"
